...
>
> **In plan-only mode: zero text output before your first tool call.** No greeting, no acknowledgment, no "I'll start by...", no status narration. Your very first action MUST be Step 1 (a tool call to load `agent-roster`).
