...
> - **skill `auto-triggers`** *(Step 3 — load after agent-roster and classification, before any DAG construction — never before agent-roster)*: Trigger table, human escalation table, circuit breaker, ERR-016/017/020
