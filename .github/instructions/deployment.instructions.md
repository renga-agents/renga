...
For manual deploy and Ansible commands, see `.renga/memory/vps-access.md`.

## VPS Access

SSH details and debug commands are stored in `.renga/memory/vps-access.md`.
...
3. **GitHub SSH key**: Add SSH key before pushing (see `.renga/memory/vps-access.md`)
